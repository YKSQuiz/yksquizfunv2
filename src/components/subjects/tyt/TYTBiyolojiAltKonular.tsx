...
const biyolojiAltKonular = [
  { id: 'canlilarin-ortak-ozellikleri', label: 'Canlıların Ortak Özellikleri', icon: '🧬', color: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)' },
  { id: 'canlilarin-temel-bilesenleri', label: 'Canlıların Temel Bileşenleri', icon: '🧱', color: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)' },
  { id: 'hucre-ve-organelleri', label: 'Hücre ve Organelleri', icon: '🦠', color: 'linear-gradient(135deg, #30cfd0 0%, #330867 100%)' },
  { id: 'madde-gecisleri', label: 'Madde Geçişleri', icon: '🔄', color: 'linear-gradient(135deg, #f7971e 0%, #ffd200 100%)' },
  { id: 'canlilarin-siniflandirilmasi', label: 'Canlıların Sınıflandırılması', icon: '🐾', color: 'linear-gradient(135deg, #f953c6 0%, #b91d73 100%)' },
  { id: 'hucre-bolunmeleri-ve-ureme', label: 'Hücre Bölünmeleri ve Üreme', icon: '➗', color: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' },
  { id: 'kalitim', label: 'Kalıtım', icon: '👨\u200d👩\u200d👧\u200d👦', color: 'linear-gradient(135deg, #43cea2 0%, #185a9d 100%)' },
  { id: 'ekosistem', label: 'Ekosistem', icon: '🏞️', color: 'linear-gradient(135deg, #ff6a00 0%, #ee0979 100%)' },
  { id: 'bitkiler-biyolojisi', label: 'Bitkiler Biyolojisi', icon: '🪴', color: 'linear-gradient(135deg, #11998e 0%, #38ef7d 100%)' },
];
...
const TYTBiyolojiAltKonular: React.FC = () => {
  ...
  return (
    <div className="container">
      <div className="header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        />
        <h1 style={{ flex: 1, textAlign: 'center', margin: 0 }}>TYT Biyoloji - Alt Konular</h1>
        <div style={{ width: 120 }} />
      </div>
        ...
        <div className="category-grid" style={{ margin: '40px 0 20px 0' }}>
          {biyolojiAltKonular.map((subj, i) => (
            <div
              ...
              onClick={() => navigate(`/biyoloji/${subj.id}`)}
              style={{
              ...
              tabIndex={0}
              onKeyDown={e => { if (e.key === 'Enter') navigate(`/biyoloji/${subj.id}`); }}
            >
...
export default TYTBiyolojiAltKonular; 