...
const felsefeAltKonular = [
  { id: 'felsefeyle-tanisma', label: 'Felsefeyle Tanışma', icon: '🤝', color: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)' },
  { id: 'bilgi-felsefesi', label: 'Bilgi Felsefesi (Epistemoloji)', icon: '📚', color: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)' },
  { id: 'varlik-felsefesi', label: 'Varlık Felsefesi (Ontoloji)', icon: '🌌', color: 'linear-gradient(135deg, #30cfd0 0%, #330867 100%)' },
  { id: 'ahlak-felsefesi', label: 'Ahlak Felsefesi (Etik)', icon: '⚖️', color: 'linear-gradient(135deg, #f7971e 0%, #ffd200 100%)' },
  { id: 'sanat-felsefesi', label: 'Sanat Felsefesi (Estetik)', icon: '🎨', color: 'linear-gradient(135deg, #f953c6 0%, #b91d73 100%)' },
  { id: 'din-felsefesi', label: 'Din Felsefesi', icon: '🕌', color: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' },
  { id: 'siyaset-felsefesi', label: 'Siyaset Felsefesi', icon: '🏛️', color: 'linear-gradient(135deg, #43cea2 0%, #185a9d 100%)' },
  { id: 'bilim-felsefesi', label: 'Bilim Felsefesi', icon: '🔬', color: 'linear-gradient(135deg, #ff6a00 0%, #ee0979 100%)' },
  { id: 'felsefe-tarihi', label: 'Felsefe Tarihi', icon: '📜', color: 'linear-gradient(135deg, #11998e 0%, #38ef7d 100%)' },
];
...
const TYTFelsefeAltKonular: React.FC = () => {
  ...
  return (
    <div className="container">
      <div className="header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        />
        <h1 style={{ flex: 1, textAlign: 'center', margin: 0 }}>TYT Felsefe - Alt Konular</h1>
        <div style={{ width: 120 }} />
      </div>
        ...
        <div className="category-grid" style={{ margin: '40px 0 20px 0' }}>
          {felsefeAltKonular.map((subj, i) => (
            <div
              ...
              onClick={() => navigate(`/felsefe/${subj.id}`)}
              style={{
              ...
              tabIndex={0}
              onKeyDown={e => { if (e.key === 'Enter') navigate(`/felsefe/${subj.id}`); }}
            >
...
export default TYTFelsefeAltKonular; 