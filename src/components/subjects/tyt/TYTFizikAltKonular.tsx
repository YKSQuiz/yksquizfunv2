...
const fizikAltKonular = [
  { id: 'fizik-bilimine-giris', label: 'Fizik Bilimine Giriş', icon: '🔬', color: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)' },
  { id: 'madde-ve-ozellikleri', label: 'Madde ve Özellikleri', icon: '🧪', color: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)' },
  { id: 'kuvvet-ve-hareket', label: 'Kuvvet ve Hareket', icon: '🏃\u200d♂️', color: 'linear-gradient(135deg, #30cfd0 0%, #330867 100%)' },
  { id: 'is-guc-enerji', label: 'İş, Güç ve Enerji', icon: '⚡️', color: 'linear-gradient(135deg, #f7971e 0%, #ffd200 100%)' },
  { id: 'isi-sicaklik-genlesme', label: 'Isı, Sıcaklık ve Genleşme', icon: '🔥', color: 'linear-gradient(135deg, #f953c6 0%, #b91d73 100%)' },
  { id: 'basinc', label: 'Basınç', icon: '💨', color: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' },
  { id: 'kaldirma-kuvveti', label: 'Kaldırma Kuvveti', icon: '🎈', color: 'linear-gradient(135deg, #43cea2 0%, #185a9d 100%)' },
  { id: 'elektrostatik', label: 'Elektrostatik', icon: '⚡️', color: 'linear-gradient(135deg, #ff6a00 0%, #ee0979 100%)' },
  { id: 'elektrik-manyetizma', label: 'Elektrik ve Manyetizma', icon: '💡', color: 'linear-gradient(135deg, #11998e 0%, #38ef7d 100%)' },
  { id: 'dalgalar', label: 'Dalgalar', icon: '🌊', color: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)' },
  { id: 'optik', label: 'Optik', icon: '👁️', color: 'linear-gradient(135deg, #30cfd0 0%, #330867 100%)' },
];
...
const TYTFizikAltKonular: React.FC = () => {
  ...
  return (
    <div className="container">
      <div className="header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        />
        <h1 style={{ flex: 1, textAlign: 'center', margin: 0 }}>TYT Fizik - Alt Konular</h1>
        <div style={{ width: 120 }} />
      </div>
        ...
        <div className="category-grid" style={{ margin: '40px 0 20px 0' }}>
          {fizikAltKonular.map((subj, i) => (
            <div
              ...
              onClick={() => navigate(`/fizik/${subj.id}`)}
              style={{
              ...
              tabIndex={0}
              onKeyDown={e => { if (e.key === 'Enter') navigate(`/fizik/${subj.id}`); }}
            >
...
export default TYTFizikAltKonular; 